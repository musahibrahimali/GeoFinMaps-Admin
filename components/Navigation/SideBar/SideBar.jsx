                                        ...
                                        <div className="bg-white dark:bg-gray-900 mt-2 relative flex-1 px-4 sm:px-6">
                                            ...
                                            <div className=" bg-white dark:bg-gray-900 absolute inset-0 px-4 sm:px-6">
                                                <div className="w-full max-w-md my-2 bg-white dark:bg-gray-900">
                                                    <ul className="flex flex-col items-center justify-center w-full h-full bg-white dark:bg-gray-900">
                                                        {
                                                            MenuItems.map((item, index) => {
                                                                return (
                                                                    <div className="w-full bg-white dark:bg-gray-900" key={index}>
                                                                        <Link href={item.url}>
                                                                            <a>
                                                                                <li onMouseDown={handleOpenDrawer}
